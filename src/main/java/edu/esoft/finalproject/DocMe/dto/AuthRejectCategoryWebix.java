...
public class AuthRejectCategoryWebix {

    List<AuthRejectCategoryWebix> data;
    ...
    public AuthRejectCategoryWebix() {
    }
    ...
    public List<AuthRejectCategoryWebix> getData() {
        return data;
    }

    public void setData(List<AuthRejectCategoryWebix> data) {
        this.data = data;
    }
