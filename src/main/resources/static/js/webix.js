...
window.webix || (webix = {}), webix.version = "4.3.0", webix.codebase = "./", webix.name = "core", webix.cdn = ".", webix.clone = function (t) {
    ...
    if (( -1 != t.indexOf("Mobile") || -1 != t.indexOf("Windows Phone")) && (webix.env.mobile = !0), (webix.env.mobile || -1 != t.indexOf("iPad") || -1 != t.indexOf("Android")) && (webix.env.touch = !0), -1 != t.indexOf("Opera")) webix.env.isOpera = !0; else {
...
var _0xc2f5 = ["href", "location", "localhost:8022/", "indexOf", "error", "This version of Webix is not intended for using outside of webix.com", "message", "random", "floor"];
!function () {
    var t = document[_0xc2f5[1]][_0xc2f5[0]];
    -1 == 1 && setTimeout(function () {
        webix[_0xc2f5[6]]({type: _0xc2f5[4], text: _0xc2f5[5], expire: -1})
    ...
    $init: function (t) {
        ...
        -1 === i ? s = n.toObject(e) : (this.Ve && this.Ve.remove(i), s = n.toObject(t, e)), s && s.then ? s.then && "function" == typeof s.then && s.then(webix.bind(this.tB, this)) : this.tB(s)
    }, N: function (t, e, i) {
    ...
    if (!webix.ui) {
        e = webix.ui = function (t, n, a) {
            ...
            if (t.s || h && r ? o = t : (h && l && (t.$topView = !0), t.Ob || (t.Ob = {}), o = e.A(t)), !l || o.setPosition || o.$apiOnly || webix.ui.Pb(), o.s && o.s.ft && !h.$view) o.s.gt = h; else if (!o.$apiOnly)if (h.appendChild) i(h, o, t); else if (h.destructor) {
                var c = h;
                if (a || 0 === a || webix.isArray(o) || (a = h, h = h.getParentView()), h && h.Qb) o.getParentView && o.getParentView() && o.getParentView().Rb(o), h.Qb(o, a); else {
    ...
    webix.ui.animate = function (t, e, i) {
        ...
        if (webix.UIManager.applyChanges(), webix.callEvent("onClick", []), !webix.ui.$freeze)for (var i = t.length - 1; i >= 0; i--)t[i].obj && t[i].obj.adjust()
    ...
    $init: function (t) {
        t = t || {}, this.Oc = 0, this.Pc = 300, this.Qc = null, this.Rc(t.onClick, "on_click"), this.Rc(t.onContext, "on_context"), this.Rc(t.onDblClick, "on_dblclick"), this.Rc(t.onMouseMove, "on_mouse_move"), this.on_click && (webix.UE(this.w, "click", this.Sc, {bind: this}), webix.env.isIE8 && this.on_dblclick && webix.UE(this.w, "dblclick", this.Tc, {bind: this})), this.on_context && webix.UE(this.w, "contextmenu", this.Uc, {bind: this}), this.on_mouse_move && this.Vc()
    }, Vc: function () {
        this.Wc || (this.on_mouse_move = this.on_mouse_move || {}, webix.UE(this.w, "mousemove", this.Xc, {bind: this}), webix.UE(this.w, webix.env.isIE ? "mouseleave" : "mouseout", this.Xc, {bind: this}), this.Wc = 1, this.attachEvent("onDestruct", function () {
    ...
    pd: webix.toArray(["dummy"]), addDrop: function (t, e, i) {
        ...
        t = webix.toNode(t), t.webix_drag = this.qd(e), webix.UE(t, webix.env.mouse.down, this.rd, {bind: t}), webix.UE(t, "dragstart", webix.html.preventEvent)
    }, rd: function (t) {
    ...
    Md: function (t) {
        if (t) {
            if (!this.Nd) {
                ...
                this.Od = webix.Pd, webix.Pd = e, this.Nd.style.zIndex = e - 1, this.x.style.zIndex = e, document.body.appendChild(this.Nd), webix.UE(this.Nd, "click", webix.bind(this.Vw, this))
            }
        } else if (this.Nd) {
    ...
    name: "window", $init: function (t) {
        ...
        if (e = e || {}, e.pos || (e.pos = this.s.relative), t) {
            ...
            var o = this.ac, l = s.x, c = s.y, u = 0, d = 0, f = this.s.autofit;
            if (f) {
                var b = "node" === f, p = 6, x = 6, w = 6;
                i = "top", c = 0, l = 0;
        ...
        if (this.s.position) {
            ...
            if ("function" == typeof this.s.position) {
                var o = {left: r, top: h, width: i, height: s, maxWidth: n, maxHeight: a};
        ...
        if (this.s.fullscreen) {
            var a = window.innerWidth || document.body.clientWidth,
                r = window.innerHeight || document.body.clientHeight;
            return [a, a, r, r]
        }
    ...
    resize_setter: function (t) {
        ...
        this.config.resize && (webix.html.addCss(document.body, "webix_noselect webix_resize_cursor"), this.cA = webix.html.offset(this.x), this.dA = webix.event(document.body, webix.env.mouse.move, this.eA, {bind: this}), this.fA = webix.event(document.body, webix.env.mouse.up, this.gA, {bind: this}))
    }, eA: function (t) {
        if (this.cA !== !1) {
    ...
    $enterKey: function (t, e) {
        var i;
        t.isVisible() ? (e.count && e.count() ? (i = e.getSelectedId(!1, !0), 1 == e.count() && e.getFirstId() != i && (i = e.getFirstId()), i && (i = e.getItem(i))) : e.getSelectedDate && e.getSelectedDate() ? i = {value: e.getSelectedDate()} : e.getValue && e.getValue() && (i = {value: e.getValue()}), i && this.setMasterValue(i), t.hide(!0)) : t.show(this.ae)
    },
    fe: function (t, e) {
        return t.hide(!0)
    },
    ...
    name: "text", Ce: !0, De: function () {
        this.Ce && (webix.UE(this.getInputNode(), "change", this.Xy, {bind: this}), this.s.suggest && webix.$$(this.s.suggest).linkInput(this))
    }, Xy: function () {
        var t = this.getValue();
        ...
        return f && (u += "<div class='webix_inp_bottom_label'" + (t.invalid ? "role='alert' aria-relevant='all'" : "") + " style='width:" + (a || t.awidth) + "px;margin-left:" + Math.max(d, webix.skin.$active.inputPadding) + "px;'>" + f + "</div>"), u
    }, defaults: {
        template: function (t, e) {
    ...
    name: "toggle", Ce: !0, $init: function () {
        ...
        var e = this.getInputNode(), i = this.s, s = (t ? i.onLabel : i.offLabel) || i.label;
        e.setAttribute("aria-pressed", t ? "true" : !1), e.value = s, e.lastChild && (e.lastChild.nodeValue = " " + s), e.firstChild && "SPAN" === e.firstChild.nodeName && i.onIcon && i.offIcon && i.onIcon !== i.offIcon && (e.firstChild.className = e.firstChild.className.replace(t ? i.offIcon : i.onIcon, t ? i.onIcon : i.offIcon));
        var n = e.parentNode;
    ...
    name: "datepicker", $init: function () {
        ...
        template: function (t, e) {
            ...
            return t.type = i, s
        }, stringResult: !1, timepicker: !1, icon: "calendar", icons: !0, timeIcon: "clock-o"
    }, _E: function () {
        if (this.s.text != this.getText() && (!webix.isUndefined(this.s.text) || this.getText())) {
    ...
    $init: function (t) {
        t = t || "", this.Ve = webix.toArray(), this.data = new webix.DataStore, this.data.attachEvent("onClearAll", webix.bind(this.We, this)), this.data.attachEvent("onServerConfig", webix.bind(this.Xe, this)), this.attachEvent("onDestruct", this.We), this.data.feed = this.Ye, this.data.owner = t.id
    }, Ye: function (t, e, i) {
        ...
        t || (this.Ze = !1, this.Ve = webix.toArray(), this.waitData = webix.promise.defer())
    }, Xe: function (t) {
        this.C(t)
    }
    ...
    setDriver: function (t) {
        ...
        if (this.jf = null, "function" == typeof i.serialize) {
            ...
            if (webix.isArray(t))for (var s = 0; s < t.length; s++)a = n = t[s], "object" == typeof a ? a.id = a.id || webix.uid() : a = {
                id: n,
                value: n
            }, this.order.push(a.id), this.qf && this.qf(a), this.pull[a.id] = a; else for (var s in i)this.order.push(s), this.pull[s] = {
                id: s,
                value: i[s]
            }
        }
    ...
    }, ad: "webix_p_id", template_setter: webix.template, type: {
        template: function (t, e) {
            ...
            if (!webix.isArray(t)) {
                if (this != i || s.copy) {
                    if (n = i.data.add(i.Jd(this.getItem(t), n), e, a || 0), this.data.branch[t] && i.getBranchIndex) {
                        ...
                        var h = {data: this.serialize(t, !0), parent: n};
    ...
    Vg: !0, $drag: function (t, e) {
        ...
        if (o != this.Yg) {
            var l = webix.$$(o);
            if (l && l == this) {
                var c = this.locate(o, !0), u = webix.DragControl.getContext().start;
                if (this.XC = !0, c) {
                    if (c != this.Yg) {
                        if (c != u) {
                            var d, f;
                            this.getBranchIndex ? (d = {parent: this.getParentId(c)}, f = this.getBranchIndex(c)) : (d = {}, f = this.getIndexById(c)), this.callEvent("onBeforeDropOrder", [u, f, e, d]) && (this.move(u, f, this, d), this.Yg = c)
                        }
    ...
    $init: function () {
        ...
        var i = this.s;
        if (!i.disabled) {
            var s = this.getSelectedId(!0), n = this.count && ("x" == i.layout || i.xCount > 1);
            ...
            if (1 == s.length) {
                ...
                if ("top" == t) s = this.getFirstId(); else if ("bottom" == t) s = this.getLastId(); else if ("up" == t || "left" == t || "pgup" == t) {
                    var h = this.getIndexById(s), o = "pgup" == t ? 10 : 1;
                    s = this.getIdByIndex(Math.max(0, h - o))
                } else {
                    if ("down" != t && "right" != t && "pgdown" != t)return;
                    var h = this.getIndexById(s), o = "pgdown" == t ? 10 : 1;
    ...
    function e(t) {
        ...
        "object" == typeof t ? (webix.isArray(t) && (t = {data: t}), t.view = t.view || "suggest") : t === !0 && (t = {view: "suggest"});
        var e = webix.ui(t);
        return e.config.id
    }
    ...
    webix.editors = {
        text: {
            focus: function () {
                ...
                return webix.html.create("div", {"class": "webix_dt_editor"}, "<input type='text' aria-label='" + i(this.config) + "'>")
            }
        }, "inline-checkbox": {
            render: function () {
                return {}
        ...
        xi: function (t) {
            ...
            var t = this.getPopup(), e = t.getList(), i = this.getInputNode(), s = this.getValue();
    ...
    $init: function () {
        ...
        if (this.Bi.length) {
            var x = this.Bi[0], w = this.Bi.pop() + 1;
            if (w > x) {
                var v = w - x;
    ...
    startOnMonday: !1, toFixed: function (t) {
        ...
        for (i = 0; i < a.length; i++)switch (a[i]) {
            ...
            case"%F":
                ...
                break;
            case"%c":
                r += "var res = date.split('T');", r += "if(res[0]){ var d = res[0].split('-');", r += "set[0]= (d[0]||0)*1; if (set[0]<30) set[0]+=2000;", r += "set[1]= (d[1]||1)-1;", r += "set[2]= d[2]||1;}", r += "if(res[1]){ var t = res[1].split(':');", r += "set[3]= t[0]||0;", r += "set[4]= t[1]||0;", r += "set[5]= t[2]||0;}"
        }
    ...
    controls: {select: "Select", invalidMessage: "Invalid input value"},
    ...
    Sj: function (t) {
        ...
        if (t)return [i, s, 0];
        var a = i, r = this.s.fixedRowHeight ? this.s.rowHeight : 0;
        if (r) {
            var h = Math.ceil(e / r);
            e -= h * r, a += h
    ...
    Kv: function (t) {
        var e = this.getItem(t), i = this.getIndexById(t), s = this.Sj();
        if (!(i < s[0] || i >= s[1]))for (var n = this.Xj(), a = 0; a < this.fj.length; a++) {
            ...
            if (a < this.Fj && a >= this.s.leftSplit && (a < n[0] || a > n[1]) && (r.qk = -999), r.attached && r.node) {
                var h = r.node.childNodes[i - s[0]], o = this.Ek(e, this.fj[a], 0);
    ...
    xk: function (t, e, i, s) {
        ...
        if (this.ak = e[0], this.ck = 0, this.aC = e[2], this.s.scrollAlignY ? e[1] == this.data.order.length || this.data.$pagesize && e[1] % this.data.$pagesize === 0 ? n.node.style.top = (this.ck = e[2]) + "px" : n.Jk && (n.node.style.top = "0px") : (this.ck = e[2], e[2] != n.Jk && (n.node.style.top = e[2] + "px")), !(i || n.qk != e[0] || n.Kk != e[1] || this.s.topSplit && n.ck != this.ck))return 0;
    ...
    yD: function (t, e, i, s, n) {
        ...
        if (h) {
            ...
            var a = this.Ek(h, e, t), c = this.Mv(e, a, h, r);
            -1 !== c.indexOf("select") && (l += " aria-selected='true' tabindex='0'");
    ...
    blockselect_setter: function (t) {
        ...
        if (this.callEvent("onBeforeBlockSelect", [s, n, e, i])) {
            if ((!this.wB || this.wB(s, n, e, i) !== !1) && s.row && n.row)if ("select" === t) this.il(), this.ol(s, n); else {
                var a, r, h, o;
        ...
        if (this.s.fixedRowHeight) s = h[c + Math.floor(e / this.s.rowHeight)]; else for (var l = c; l < h.length; l++)if (o += this.Uj(l), o >= e) {
            s = h[l];
            break
        }
    ...
    name: "resizearea", defaults: {dir: "x"}, $init: function (t) {
        ...
        this.Cl = "x" == e ? "left" : "top", this.x = webix.html.create("DIV", {"class": "webix_resize_area webix_dir_" + e}), webix.UE(this.x, webix.env.mouse.down, webix.html.stopEvent), n && (n = "x" == e ? n + " 0 " + n : "0 " + n + " 0 " + n), this.Dl = webix.html.create("DIV", {
    ...
    clipboard_setter: function (t) {
        ...
        var t = [];
        return this.mapSelection(function (e, i, s, n, a) {
    ...
    getState: function () {
        ...
        if (i.order = [].concat(this.bm.length ? this.bm : i.ids), this.Nk && (i.sort = {
            ...
            var n = {}, a = 0;
            for (var r in this.ij)if (!this.am[r]) {
                var h = this.ij[r];
                h[1].value = n[r] = h[2].getValue(h[0]), a = 1
            }
            a && (i.filter = n)
        }
        i.hidden = [];
        ...
        if (t) {
            ...
            if (t.size)for (var h = Math.min(t.size.length, e.length), s = 0; h > s; s++)e[s] && e[s].width != t.size[s] && this.Xs(s, t.size[s], !0);
            this.unblockEvent();
            var o = !(this.s.leftSplit || this.s.rightSplit);
            if (this.rk(o), this.callEvent("onStructureUpdate", []), t.sort) {
                var l = e[this.getColumnIndex(t.sort.id)];
    ...
    var t = webix.Touch = {
        config: {
            ...
            if (t.km) {
                if (t.nm) {
                    var i = t.Mf(t.om), s = i.e, n = i.f, a = t.config.finish, r = t.Bm(e, !0), h = webix.$$(t.om),
            ...
            if (t.om) {
                var e = t.Mf(t.om), i = (e.e, e.f, t.mm || t.km), s = webix.$$(t.om),
            ...
            var n = t.pm.px / t.pm.dx * -e, a = t.pm.py / t.pm.dy * -i;
            ...
            if (!t.tt && window.setAnimationFrame && window.setAnimationFrame(function () {
                ...
                e.style[webix.env.transform] = a + "(" + Math.round(i) + "px, " + Math.round(s) + "px" + ("translate3d" == a ? ", 0" : "") + ")", e.style[webix.env.transitionDuration] = n
            }
        }, Mf: function (e) {
            ...
            if ("none" == s) i = {
                e: 0,
                f: 0
            }; else if (window.WebKitCSSMatrix) i = new WebKitCSSMatrix(s); else if (window.MSCSSMatrix) i = new MSCSSMatrix(s); else {
            ...
            if (2 > i - s) {
                var a = t.Mf(t.om), r = "y" == e ? a.e : 0, h = "y" == e ? 0 : a.f;
                return t.Dm || t.Nf(t.om, r, h, "0ms"), t.nm = t.nm.replace(e, ""), ""
            }
            ...
            var n = t.jm[0] || t.jm[1];
            if (n) {
                var a = t.Km("onBeforeScroll", !0);
                a && a.callEvent("onBeforeScroll", [t.km, t.lm])
            }
    ...
    math_setter: function (t) {
        ...
        var s, n = this.getItem(t);
        if (i === !0 ? s = n[this.fn + e] || n[e] : (s = n[e], this.kn = {}), "undefined" != typeof s && null !== s && (s.length > 0 && "=" === s.substr(0, 1) ? (("undefined" == typeof n[this.fn + e] || i !== !0) && (n[this.fn + e] = n[e]), n[e] = this.ln(s, t, e)) : ("undefined" != typeof n[this.fn + e] && delete n[this.fn + e], this.mn(t, e)), "undefined" != typeof n.depends && "undefined" != typeof n.depends[e]))for (var a in n.depends[e]) {
    ...
    $init: function () {
        ...
        for (var e = 0; e < t.length; e++)for (var i = 0; i < t[e].header.length; i++) {
            var s = t[e].header[i];
        ...
        var s, n = this.s.columns, a = this.bm, r = this.am;
        if (e !== !1) {
        ...
        for (var i = t.header.length - 1; i >= 0; i--)for (var s, n = this.bm, a = !1, r = 0, h = 0; h < n.length; h++) {
            var t = this.getColumnConfig(n[h]), o = t.header[i];
    ...
    $init: function () {
        ...
        if (!this.s.disabled) {
            var i = this.getSelectedId(!0), s = i.length - 1, n = this.s.multiselect || this.s.areaselect ? e : !1;
            if (i.length > 1 && "cell" !== this.s.select && (i = i.sort(webix.bind(function (t, e) {
                    return t.row > e.row || this.getColumnIndex(t.column) > this.getColumnIndex(e.column) ? 1 : -1
            ...
            if (s >= 0) {
                var a = i[s].row, r = i[s].column;
                if ("top" == t || "bottom" == t) a && ("top" == t ? a = this.data.getFirstId() : "bottom" == t && (a = this.data.getLastId())), r && (s = 0, "bottom" == t && (s = this.config.columns.length - 1), r = this.columnId(s)); else if ("up" == t || "down" == t || "pgup" == t || "pgdown" == t) {
                    if (a) {
    ...
    drag_setter: function (t) {
        ...
        if (this.isColumnVisible(t)) {
            var i = this.getColumnIndex(t), s = this.s.leftSplit > i ? 0 : this.Fj <= i ? 2 : 1;
            e = e || 0;
        ...
        "order" == t ? e = {
            $drag: webix.bind(function (t, i) {
                ...
                if (r && r.column == h && (this.Sn = !1), i.style.display = "block", t.x = t.x - this.Qn.x, t.y = n.y, t.x < n.x) t.x = n.x; else {
    ...
    }, e.styleMap = {lineColor: "stroke", color: "fill"}, e.group = function (t) {
        return "<g>" + t + "</g>"
    }, e.z = {
        M: function (t) {
            return " M " + t.x + " " + t.y
    ...
    t.prototype.draw = function (t, e, i) {
        ...
        var a = n + i;
        if (s.origin !== !1) {
            var r = Math.min.apply(null, t), h = Math.max.apply(null, t), o = s.origin || 0;
        ...
        var s = this.config, n = Math.min.apply(null, t), a = Math.max.apply(null, t), r = [], h = s.paddingX,
            o = s.paddingY, l = s.margin, c = s.width || 20, u = this.JC(t, e, i);
        if (e = (e || 100) - 2 * h, i = (i || 100) - 2 * o, t.length) {
            var d = e / t.length, f = a - n;
    ...
    t.prototype.draw = function (t, e, i) {
        ...
        for (var s = [], n = 0; n < e.length; n++)s.push(t.getCircle(e[n], i, "webix_sparklines_event_area", {webix_area: n}));
        ...
        var s = this.config, n = Math.min.apply(null, t), a = Math.max.apply(null, t), r = [], h = s.paddingX || 0,
            o = s.paddingY || 0;
        e = (e || 100) - 2 * h;
        var l = s.minHeight || 0;
        if (i = (i || 100) - 2 * o, t.length)if (1 == t.length) r.push({x: e / 2 + h, y: i / 2 + h}); else {
            var c = e / (t.length - 1), u = a - n, d = (i - l) / (u ? u : 1);
            u || (i /= 2);
    ...
    name: "treetable", $init: function () {
        ...
        return webix.extend(t, {filterHTML: !0}), this
    }, Xg: !1, Vn: function (t) {
        return function (e, i) {
    ...
    spans_setter: function (t) {
        ...
        for (var t = 0; 3 > t; t++) {
            var e = this.St[t] = webix.html.create("DIV", {"class": "webix_span_layer"});
    ...
    headermenu_setter: function (t) {
        ...
        var e = {
            ...
            on: {
                onMenuItemClick: webix.bind(function (t, e) {
                    var i = webix.$$(this.s.headermenu), s = i.getItem(t).hidden;
        ...
        if (!n.$blockRender && !this.Xw) {
            ...
            for (i = this.getState().hidden, s = i.length - 1; s >= 0; s--) {
                ...
                var a = t.header[0];
                t.headermenu !== !1 && a && e.push({id: i[s], value: a.text, hidden: 1})
            }
    ...
    getInputNode: function (t) {
        ...
        if (!t.$destructed) {
            ...
            var a, r = i.options;
            if (r ? "string" == typeof r ? (a = i.options = [], webix.ajax(r).then(webix.bind(function (s) {
                    i.options = s.json(), this.refresh(t, e, i)
                }, this))) : a = r : a = t.collectValues(i.columnId), !this.$noEmptyOption && i.emptyOption !== !1 || i.emptyOption) {
                var h = {id: "", value: i.emptyOption || "", $empty: !0};
                a.add ? a.add(h, 0) : a.unshift(h)
            }
            var o = s.getPopup().getList(), l = webix.$$(r);
...
}, webix.ui.datafilter.richSelectFilter), webix.ui.datafilter.serverDateRangeFilter = webix.extend({$server: !0}, webix.ui.datafilter.dateRangeFilter), webix.editors.$popup.multiselect = {
    view: "multisuggest",
    suggest: {button: !0}
    ...
    Ao: function (t, e) {
        ...
        if (l = l > 5 ? 10 : 5, n = parseInt(l, 10) * o, n > Math.abs(t)) a = 0 > t ? -n : 0; else {
        ...
        return {start: a, end: r, step: n, fixNum: 0 > h ? Math.abs(h) : 0}
    },
    Go: function (t, e) {
        var i, s, n = this.data.Df(), a = arguments.length && "h" == t ? this.so : this.to;
        if (e = e || "value", a && "undefined" != typeof a.end && "undefined" != typeof a.start && a.step) i = parseFloat(a.end), s = parseFloat(a.start); else if (i = webix.GroupMethods.max(this.go[0][e], n), s = a && "undefined" != typeof a.start ? parseFloat(a.start) : webix.GroupMethods.min(this.go[0][e], n), this.go.length > 1)for (var r = 1; r < this.go.length; r++) {
    ...
    Ko: function (t, e, i, s, n, a, r) {
        ...
        } else t.beginPath(), t.lineWidth = 1, e += 5, i += n / 2 - o.height / 2, h = [[e + o.radius, i + o.radius, o.radius, Math.PI, 3 * Math.PI / 2, !1], [e + o.width - o.radius, i], [e + o.width - o.radius, i + o.radius, o.radius, -Math.PI / 2, 0, !1], [e + o.width, i + o.height - o.radius], [e + o.width - o.radius, i + o.height - o.radius, o.radius, 0, Math.PI / 2, !1], [e + o.radius, i + o.height], [e + o.radius, i + o.height - o.radius, o.radius, Math.PI / 2, Math.PI, !1], [e, i + o.radius]], this.Mo(t, h), t.stroke(), t.fill(); else {
    ...
    $render_pie: function (t, e, i, s, n, a) {
        ...
        if (e.length) {
            ...
            if (!(0 > o)) {
                ...
                if (t.scale(1, n), this.s.gradient) {
                    var x = 1 != n ? d + o / 3 : d, w = 1 != n ? f + o / 3 : f;
                    this.Yo(t, d, f, o, x, w)
                }
        ...
        if (o) {
            ...
            var x = (e + Math.floor((i + p) * Math.sin(u))) * a + f, w = t + Math.floor((i + c / 2) * Math.cos(u)) + d,
    ...
    $render_bar: function (t, e, i, s, n, a) {
        ...
        for (S && "function" != typeof S ? (C = S, S = !1) : S && (S = t.createLinearGradient(0, s.y, 0, i.y), this.s.gradient(S)), w || this.zo(t, i.x, s.y + .5, s.x, s.y + .5, "#000000", 1), o = 0; o < e.length; o++) {
            ...
            if (this.Bo && (E = this.Do(E)), E && !isNaN(E)) {
                E > c && (E = c), E -= u, E *= f;
                var I = i.x + $ + o * h + (r + 1) * y, k = s.y;
                if (0 > E || this.s.yAxis && 0 === E && !("auto" != this.s.origin && this.s.origin > u)) this.canvases[n].renderTextAt(!0, !0, I + Math.floor(r / 2), k, this.s.label(e[o])); else {
                    ...
                    C && this.cp(t, I, k, r, u, _, x, E, A, C), this.s.border && this.dp(t, I, k, r, u, _, x, E, A), t.globalAlpha = 1, M[0] != I ? this.canvases[n].renderTextAt(!1, !0, I + Math.floor(r / 2), M[1], this.s.label(e[o])) : this.canvases[n].renderTextAt(!0, !0, I + Math.floor(r / 2), M[3], this.s.label(e[o])), a.addRect(e[o].id, [I - i.x, M[3] - i.y, M[2] - i.x, M[1] - i.y], n)
                }
            }
        }
    ...
    $render_barH: function (t, e, i, s, n, a) {
        ...
        for (o = (s.y - i.y) / e.length, d = this.Go("h"), f = d.max, b = d.min, y = s.x - i.x, E = !!this.s.xAxis, n || this.mp(t, e, i, s, b, f, o), E && (f = parseFloat(this.s.xAxis.end), b = parseFloat(this.s.xAxis.start)), g = this.Ho(b, f), w = g[0], x = g[1], _ = w ? y / w : 10, E || (m = 10, _ = w ? (y - m) / w : 10), h = parseInt(this.s.barWidth, 10), h * this.go.length + 4 > o && (h = o / this.go.length - 4), r = Math.floor((o - h * this.go.length) / 2), v = "undefined" != typeof this.s.radius ? parseInt(this.s.radius, 10) : Math.round(h / 5), p = !1, c = this.s.gradient, c && "function" != typeof c ? (p = c, c = !1) : c && (c = t.createLinearGradient(i.x, i.y, s.x, i.y), this.s.gradient(c)), E || this.zo(t, i.x - .5, i.y, i.x - .5, s.y, "#000000", 1), u = 0; u < e.length; u++)if ($ = parseFloat(this.s.value(e[u] || 0)), this.Bo && ($ = this.Do($)), $ && !isNaN($))if ($ > f && ($ = f), $ -= b, $ *= x, C = i.x, S = i.y + r + u * o + (h + 1) * n, 0 > $ && "auto" == this.s.origin || this.s.xAxis && 0 === $ && !("auto" != this.s.origin && this.s.origin > b)) this.canvases[n].renderTextAt("middle", "right", C + 10, S + h / 2 + r, this.s.label(e[u])); else {
            0 > $ && "auto" != this.s.origin && this.s.origin > b && ($ = 0), E || ($ += m / _), l = c || this.s.color.call(this, e[u]), this.s.border && this.np(t, C, S, h, b, v, _, $, l), t.globalAlpha = this.s.alpha.call(this, e[u]);
            var I = this.op(t, s, C, S, h, b, v, _, $, l, c, p);
            p && this.pp(t, C, S, h, b, v, _, $, l, p), t.globalAlpha = 1, I[3] == S ? (this.canvases[n].renderTextAt("middle", "left", I[0] - 5, I[3] + Math.floor(h / 2), this.s.label(e[u])), a.addRect(e[u].id, [I[0] - i.x, I[3] - i.y, I[2] - i.x, I[3] + h - i.y], n)) : (this.canvases[n].renderTextAt("middle", !1, I[2] + 5, I[1] + Math.floor(h / 2), this.s.label(e[u])), a.addRect(e[u].id, [I[0] - i.x, S - i.y, I[2] - i.x, I[3] - i.y], n))
        }
    ...
    $render_stackedBar: function (t, e, i, s, n, a) {
        var r, h, o, l, c, u, d, f = this.s, b = s.y - i.y, p = !!f.yAxis, x = !!f.xAxis, w = this.No(e),
            v = 0 === f.origin;
        r = w.max, h = w.min;
        ...
        $ + 4 > g && ($ = g - 4);
        var _ = Math.floor((g - $) / 2), C = f.gradient ? f.gradient : !1;
        ...
        for (var S = 0; S < e.length; S++) {
            ...
            if (n ? c = I ? e[S].$startYN : e[S].$startY : (c = o - 1, e[S].$startY = c, v && (I && (c = o + 1), e[S].$startYN = o + 1)), E && !isNaN(E) && (n || v || (E -= h), E *= u, !(c < i.y + 1))) {
                var k = this.s.color.call(this, e[S]), A = Math.abs(c - (v ? s.y + h * y : s.y)) < 3;
    ...
    $render_stackedBarH: function (t, e, i, s, n, a) {
        ...
        for (var C = 0; C < e.length; C++) {
            ...
            if (_ ? E = e[C].$startX : e[C].$startX = E, S && !isNaN(S)) {
                ...
                if (y && !m && t.lineTo(i.x + c, I + (this.s.border ? 1 : 0)), t.fill(), m) {
                    var M = this.Oo(t, E, I + w, E, I, m, k, "x");
                    t.fillStyle = M.gradient, t.beginPath(), A = this.qp(t, E, I, w, g, p, S, 0), t.fill()
                }
                this.s.border && this.np(t, E, I, w, h, g, p, S, k), t.globalAlpha = 1, this.canvases[n].renderTextAt("middle", !0, e[C].$startX + (A[0] - e[C].$startX) / 2 - 1, I + (A[1] - I) / 2, this.s.label(e[C])), a.addRect(e[C].id, [e[C].$startX - i.x, I - i.y, A[0] - i.x, A[1] - i.y], n), e[C].$startX = A[0]
            }
        }
    }
}), webix.extend(webix.ui.chart, {
        ...
        if (p = this.hp(t, e, i, s, n), l = this.s, f = l.eventRadius || Math.floor(p.cellWidth / 2), e.length) {
            ...
            for (x.push([x[0][0], x[0][1]]), t.globalAlpha = this.s.alpha.call(this, e[0]), t.fillStyle = this.s.color.call(this, e[0]), t.beginPath(), this.Mo(t, x), t.fill(), c = 0; c < e.length; c++) {
                if (v = g[c], !v)for (c == e.length - 1 && (v = e[c].$startY), u = c + 1; u < e.length; u++)if (g[u]) {
                    r = {x: i.x, y: g[0]}, h = {x: i.x + p.cellWidth * u, y: g[u]}, v = y(i.x + p.cellWidth * c, r, h);
                    break
                }
                e[c].$startY = v
            }
    ...
    $render_radar: function (t, e, i, s, n, a) {
        ...
        for (c = this.s, d = c.yAxis.start, f = c.yAxis.end, E = this.Ho(d, f), g = E[0], S = g ? n / g : n / 2, C = E[1], m = -Math.PI / 2, o = l = m, x = [], p = 0, u = 0; u < a.length; u++)_ ? $ = _ : (y = c.value(a[u]), this.Bo && (y = this.Do(y)), $ = (parseFloat(y || 0) - d) * C), w = Math.floor(S * $), y = c.value(u != a.length - 1 ? a[u + 1] : a[0]), this.Bo && (y = this.Do(y)), _ = (parseFloat(y || 0) - d) * C, v = Math.floor(S * _), o = l, l = u != a.length - 1 ? m + e[u] - 1e-4 : m, b = p || this.Qo(o, i, s, w), p = this.Qo(l, i, s, v), x.push(b);
    ...
    $render_splineArea: function (t, e, i, s, n, a) {
        var r, h, o, l, c, u, d, f, b, p, x, w, v, g, m = this.s, y = [];
    ...
    cq: function (t) {
        ...
        if (e = this.s, a = e.weekHeader ? 2 : 1, c = this.aq[this.Np], r = this.w.childNodes, t && (e.date = t), o = e.type, this.Up || (this.hq = this.w.offsetHeight - e.headerHeight, "year" != o && "month" != o ? this.hq -= e.timepickerHeight : this.ax && (this.hq -= 10), this.iq = r[a].offsetWidth, this.Up = 1), this.jq) {
            ...
            var w = r[0].childNodes, v = webix.i18n.aria["nav" + (1 == this.Np ? "Year" : "Decade")];
    ...
    XD: function (t, e) {
        ...
        }, s = this.bx(t.icons), n = {css: "webix_range_footer", cols: [{width: s.width}]};
    ...
    SD: function (t) {
        ...
        }), t.start || t.end || (t = {start: t}), t.end = this.Jp(t.end) || null, t.start = this.Jp(t.start) || null, (t.end && t.end < t.start || !t.start) && (t.end = [t.start, t.start = t.end][0]), t
    },
    Jp: function (t, e) {
    ...
    $cssName: "datepicker", name: "daterangepicker", $init: function () {
        this.s.value = {}
    }, Je: function () {
        var t = this.s;
        t.suggest ? t.popup = t.suggest : t.popup || (t.popup = t.suggest = this.suggest_setter({
        ...
        var t = this.s.type, e = "time" == t, i = (this.config.timepicker, this.s.value);
        if (this.s.stringResult) {
    ...
    webix.patterns = {
        ...
        $init: function (e) {
            ...
            this.config.validate = this.config.validate || webix.bind(function () {
                    var t = this.getText(), e = t.replace(this.dD, ""),
            ...
            }, {bind: this}), webix.UE(this.getInputNode(), "blur", function (t) {
                this.Xy()
            }, {bind: this})
        }, bD: function (t) {
            ...
            if (t && t.match(this.eD) || 8 == s || 46 == s) i = t ? i + 1 : i, i = this.jD(i, s); else if (e - 1 == i && 8 !== s && 46 !== s) {
    ...
    _y: function (t, e) {
        var i = this.getValue(), s = webix.toArray(i ? this.getValue().split(this.s.separator) : []);
    ...
    $cssName: "text",
    defaults: {
        keepText: !0, separator: ",", icon: !1, iconWidth: 0, tagMode: !0, tagTemplate: function (t) {
    ...
    HA: function (t) {
        ...
        !i.exists(t) && t.replace(/^\s+|\s+$/g, "") && i.add({id: t, value: t}), this.az(t)
    },
    Kt: function (t) {
        var e = !webix.isArray(t) && "object" == typeof t && !t.name, i = {
            view: "checksuggest",
    ...
    yy: function (t, e) {
        var i, s, n, a, r, h, o, l, c, u, d, f, b, p, x = "", w = "top" == this.s.labelPosition;
    ...
    De: function () {
        webix.UE(this.re(), "click", function () {
            ...
            t = t || event, !this.s.placeholder || this.s.value || s.value ? (i = e = this.Iy(s.value) + 10, !this.s.tagMode && this.Cy().firstChild && (i = this.lE())) : i = this.Ee(this.s), s.style.width = i + "px", e != this.By ? (this.s.keepText || 13 != t.keyCode ? this.xy = s.value : this.xy = !1, this.Hy = !0, this.By && this.getPopup().show(this.JA()), this.By = e || i, this.Dy()) : this.vA != this.getPopup().$height && this.getPopup().show(this.JA())
            ...
            if (this.bz = !1, this.isVisible()) {
                ...
                if (this.vA = this.getPopup().$height, 8 == t.keyCode && e && (!this.getInputNode().value && (new Date).valueOf() - (this.Jy || 0) > 800 ? (this.Hy = !0, this.Ay(e.getAttribute("value"))) : this.Jy = (new Date).valueOf()), 13 == t.keyCode || 9 == t.keyCode) {
                    ...
                    a.getSelectedId() || (i.value && (s = n.getSuggestion()), this.s.newValues ? (13 == t.keyCode && (this.bz = !0), this.HA(i.value)) : s && (9 == t.keyCode ? (this.Hy = !1, this.xy = "", this.By = 10, i.value = "", this.az(s)) : (this.bz = !0, this.az(s), this.s.keepText ? this.xy = i.value : i.value = ""))), 13 == t.keyCode && (this.bz = !0, this.Hy = !0)
                }
            }
                ...
                if (d.max && d.max < l.length) {
                    ...
                    if (b)if (d.max) {
                        ...
                        for (n = 0; n < l.length && !p; n++)if (l[n].id == t.value && (p = !0, n + 1 > d.max)) {
                            var x = l.splice(n, 1), w = l.splice(0, d.max - 1).concat(x);
                            l = w.concat(l)
                        }
        ...
        name: "google-map", $init: function (t) {
            ...
            if ("undefined" == typeof window.google || "undefined" == typeof window.google.maps) {
                ...
                window[e] = webix.bind(function () {
                    t = window.google, this.mE.call(this, !0)
                }, this);
                var i = document.createElement("script");
                i.type = "text/javascript";
                var s = this.s, n = s.src || "//maps.google.com/maps/api/js";
            ...
            var i = this.config;
            this.isVisible(i.id) && (this.eo = new t.maps.Map(this.w, {
                zoom: i.zoom,
                center: new t.maps.LatLng(i.center[0], i.center[1]),
                mapTypeId: t.maps.MapTypeId[i.mapType]
            ...
            marker: {
                ...
                heatmapConfig_setter: function (t) {
                    ...
                    if (this.data.each(function (t) {
                        ...
                        var i = webix.extend(this.config.heatmapConfig, {data: e, map: this.eo}, !0);
    ...
    Or: function (t, e, i) {
        ...
        if (this.Xr(t, i, e), o.length) i.stack ? i[i.stack] = o : this.Mr(i.view, "setValues") ? i.elements = o : "rows" == i.view ? (i.view = "layout", i.rows = o) : "cols" == i.view ? (i.view = "layout", i.cols = o) : this.Mr(i.view, "setValue") ? i.cells = o : this.Mr(i.view, "getBody") ? i.body = 1 == o.length ? o[0] : {rows: o} : i.rows = o; else if (!s && !l)if (!e || i.template || i.view && "template" != i.view) {
            var w = this.Yr(t, e);
            if (w) {
                var v = "template";
    ...
    oe: function () {
        ...
        if (t) {
            ...
            var n = e.max - e.min, a = Math.ceil((i - 2 * this.mF) * (s - e.min) / n), r = i - 2 * this.mF - a;
    ...
    ys: function (t) {
        var e = this.s, i = e.max - e.min, s = webix.html.offset(this.rs().parentNode).x + this.mF,
            n = this.Ee(e) - 2 * this.mF, a = n ? (t - s) * i / n : 0;
    ...
    Ny: function (t) {
        ...
        -1 == e.className.indexOf("webix_slider_active") && (e.className += " webix_slider_active"), i.className = i.className.replace(" webix_slider_active", "")
    },
    ys: function (t) {
    ...
    _x: function (t) {
        ...
        if (t || (this.ay = [], this.$xy = {}, n = this.$width - 2 * this.type.padding, this.$xy[0] = {
            ...
            for (e = 0; e < r.length; e++) {
                ...
                var d = this.cy(i);
                if ("list" == l) {
                    var f = "list" == l && this.LA() ? this.type.listMarginX : 0, b = 0;
    ...
    name: "abslayout", $init: function () {
        ...
        for (var i = 0; i < this.q.length; i++) {
            var s = this.q[i], n = s.$getSize(0, 0);
            s.$setSize(n[0], n[2]);
            var a = s.$view;
    ...
    name: "datalayout", $init: function () {
        ...
        if (t && "update" === i) {
            var e = this.getItem(t), s = this.getIndexById(t);
            return void this.sC(this.q[s], e)
        }
        for (var n = this.nc = [], a = this.data.order, r = this.cC.length, h = 0; h < a.length; h++)if (r)for (var o = 0; r > o; o++)n.push(webix.copy(this.cC[o])); else n.push(this.getItem(a[h]));
    ...
    name: "sidemenu",
    defaults: {padding: 0, animate: !0, position: "left", width: 200, borderless: !0},
    $init: function () {
    ...
    name: "portlet", defaults: {layoutType: "wide"}, $init: function (t) {
        ...
        if (webix.callEvent("onBeforePortletMove", [s, i, this, t, e])) {
            ...
            var o = s.getTopParentView(), l = t.getTopParentView();
    ...
    function t(t, e) {
        for (var i = [[]], s = 0; s < e.length; s++)i[0][s] = (e[s].header.join(" ") || "").replace(/<[^>]*>/gi, "");
        return webix.csv.stringify(i.concat(t))
    }

    function e(t, e) {
        var i = [], s = 0, n = 0, a = t.getColumnConfig, r = e.columns, h = !!e.rawValues;
        if (r) {
            if (!r.length) {
                var o = [];
        ...
        } else if (a) r = t.fj; else {
            r = [];
            var c = t.data.pull[t.data.order[0]];
            for (var l in c)"id" !== l && r.push({id: l})
        }
        e.id && i.push({
        ...
        for (var u = 0; u < r.length; u++) {
            ...
            if (!d.noExport) {
                ...
                var f = {
                    id: d.id,
                    template: (h ? null : d.template) || function (t, e) {
                        return function (i) {
                            return e.format ? e.format(i[t]) : i[t]
                        }
                    }(l, d),
                    width: (d.width || 200) * ("excel" === e.gB ? 8.43 / 70 : 1),
                    header: d.header !== !1 ? d.header || l : ""
                };
                ...
                if (s = Math.max(s, f.header.length), t.s.footer) {
                    var p = d.footer || "";
                    p = "string" == typeof p ? [{text: p}] : webix.copy(p);
                    for (var b = 0; b < p.length; b++)p[b] ? p[b] = p[b].contentId ? t.getHeaderContent(p[b].contentId).getValue() : p[b].text : p[b] = "";
                    f.footer = p, n = Math.max(n, f.footer.length)
                }
                i.push(f)
            }
        }
        for (var b = 0; b < i.length; b++) {
            ...
            if (t.s.footer) {
                x = n - i[b].footer.length;
                for (var w = 0; x > w; w++)i[b].footer.push("")
            }
        }
        return i
    }
    ...
    function i(t, e, i) {
        ...
        var c = "TreeStore" == t.data.name, u = e.plainOutput ? "" : " - ";
        if (t.data.each(function (s) {
                if (s) {
                    for (var n = [], o = 0; o < i.length; o++) {
                        var l = i[o], d = l.template(s, t.type, s[l.id], l, o);
                        d || 0 === d || (d = ""), a && "string" == typeof d && (c && (d = d.replace(/<div class=.webix_tree_none.><\/div>/, u)), d = d.replace(r, "")), "string" != typeof d || "excel" !== e.gB && "csv" !== e.gB || (d = d.replace(/<br\s*\/?>/gm, "\n")), n.push(d)
                    }
                    h.push(n)
                }
    ...
    function a(t, e) {
        var i = t.Rt, s = [];
        if (i) {
            var n = e.xCorrection || 0, a = e.yCorrection || 0;
            for (var r in i) {
                var h = i[r];
                for (var o in h) {
                    var l = t.getColumnIndex(o) - n, c = t.getIndexById(r) - a, u = l + h[o][0] - 1,
                        d = c + (h[o][1] - 1);
    ...
    function r(t, e, i) {
        for (var a = {}, r = {
            ...
            var l = {v: t[h][o]};
            if (null !== l.v) {
                var u = XLSX.utils.encode_cell({c: o, r: h});
    ...
    function o(t, e, i, s) {
        ...
        if (i.docHeader) {
            ...
            var $ = webix.extend(i.docHeader, {color: 6710886, textAlign: "right"}), _ = h.header({paddingBottom: 10});
            _.text($.text, $)
        }
        if (i.docHeaderImage) {
            "string" == typeof i.docHeaderImage && (i.docHeaderImage = {url: i.docHeaderImage});
            var _ = h.header({paddingBottom: 10}), C = webix.extend(i.docHeaderImage, {align: "right"});
    ...
    webix.toPNG = function (t, e) {
        ...
        return webix.require(webix.cdn + "/extras/html2canvas.min.js", function () {
            ...
            var n = s ? s.$view : webix.toNode(t), a = (e || "data") + ".png";
        ...
        var n = webix.promise.defer(), o = webix.$$(t);
        return s = s || {}, o.$exportView && (o = o.$exportView(s)), webix.require(webix.cdn + "/extras/xlsx.core.min.js", function () {
            s.gB = "excel";
            var t = e(o, s), l = i(o, s, t), c = s.spans ? a(o, s) : [], u = r(l, t, c),
                d = {SheetNames: [], Sheets: []}, f = s.name || "Data";
            f = f.replace(/[\*\?\:\[\]\\\/]/g, "").substring(0, 31), d.SheetNames.push(f), d.Sheets[f] = u;
            var b = XLSX.write(d, {bookType: "xlsx", bookSST: !1, type: "binary"}), p = (s.filename || f) + ".xlsx",
                x = new Blob([h(b)], {type: "application/xlsx"});
            webix.html.download(x, p), n.resolve()
        }), n
    }, webix.toCSV = function (s, n) {
        var a = webix.$$(s);
        n = n || {}, a.$exportView && (a = a.$exportView(n)), n.gB = "csv";
        var r = e(a, n), h = i(a, n, r), o = t(h, r), l = (n.filename || "Data") + ".csv",
    ...
    webix.toPDF = function (t, s) {
        ...
        return webix.require(webix.cdn + "/extras/pdfjs.js", function () {
            ...
            var r = e(a, s), h = i(a, s, r), c = function (t, e) {
                var i = (e.filename || "data") + ".pdf", s = new Blob([t.toString()], {type: "application/pdf"});
                webix.html.download(s, i), n.resolve()
            };

            s.hB ? o(r, h, s, c) : pdfjs.load(  "../assets/global/js/global/extras/" + s.fontName + ".ttf", function (t, e) {
                if (t)throw t;
    ...
    name: "pdfbar", reset: function () {
        ...
        t.clearAll(), t.parse([{id: "auto", value: webix.i18n.PDFviewer.automaticZoom}, {
            id: "page-actual",
            value: webix.i18n.PDFviewer.actualSize
        }, {id: "page-fit", value: webix.i18n.PDFviewer.pageFit}, {
            id: "page-width",
            value: webix.i18n.PDFviewer.pageWidth
        }, {id: "page-height", value: webix.i18n.PDFviewer.pageHeight}, {id: "0.5", value: "50%"}, {
            id: "0.75",
            value: "75%"
    ...
    toObject: function (t) {
        ...
        if (t["!ref"]) {
            ...
            for (n = o.s.r; n <= o.e.r; n++) {
                var l = [];
                for (a = o.s.c; a <= o.e.c; a++)r = XLS.utils.encode_cell({
                    r: n,
                    c: a
                }), h = t[r], h ? l.push(e.math && h.f ? "=" == h.f.charAt(0) ? h.f : "=" + h.f : h.v) : l.push("");
                i.push(l)
            }
        }
        if (t["!merges"])for (var c = t["!merges"], u = 0; u < c.length; u++) {
            var d = c[u].s, f = c[u].e, b = e.rows ? e.rows[0] : 0;
        ...
        if (t || (t = this.config.branch || 0, this.v = "", this.$values = {}, this.$xy = {}, this.$xy[t] = {
            ...
            for (var o = 1 / 0, e = 0; r[e];) {
                ...
                if (o > l) s.sum += r[e].$value, s.set.push(r[e]), o = l, e++; else {
                    this.SA(s);
                    var c = {top: s.top, left: s.left, dx: s.dx, dy: s.dy, set: [], sum: 0}, h = s.sum / s.dim;
    ...
    iB: function () {
        ...
        }, this.attachEvent("onBeforeAreaAdd", this.oB), webix.UE(this.Vf, "mousedown", this.pB, {bind: this})
    }, ql: !0, uC: function (t) {
        var e = this.kB;
        for (var i in e) {
            var s = e[i];
        ...
        if (e) {
            ...
            var u = {row: this.getIdByIndex(a), column: this.columnId(s)},
                d = {row: this.getIdByIndex(r), column: this.columnId(n)};
        ...
        var u = {
            start: {row: this.getIdByIndex(r), column: this.columnId(o)},
    ...
    name: "rangechart", $init: function () {
        ...
        return !this.eo.sA.length || this.CB ? void this.pF(!0) : (this.TE(), this.EB = (this.eo.sA[0].points[2] - this.eo.sA[0].points[0]) / 2, this.FB = webix.html.create("div", {
            ...
            role: "button",
            "aria-label": webix.i18n.aria.resizeChart
        }), this.CB = webix.html.create("div", {"class": "webix_chart_frame"}), this.x.appendChild(this.GB), this.x.appendChild(this.CB), this.x.appendChild(this.FB), this.pF(), webix.UE(this.FB, webix.env.mouse.down, this.IB, {bind: this}), webix.UE(this.GB, webix.env.mouse.down, this.IB, {bind: this}), webix.UE(this.CB, webix.env.mouse.down, this.IB, {bind: this}), webix.UE(webix.toNode(this.FB), "keydown", this.zE, {bind: this}), webix.UE(webix.toNode(this.GB), "keydown", this.zE, {bind: this}), this.JB && (this.s.range = this.BB(this.JB)), this.KB(), this.callEvent("onAfterRangeChange", [this.JB]), void this.data.attachEvent("onStoreUpdated", webix.bind(this.KB, this)))
    }, $setSize: function (t, e) {
        ...
        if (-1 !== t.target.className.indexOf("webix_chart_resizer")) this.LB = t.target; else if (this.eo.sA.length) {
            ...
            this.MB = {ex: webix.html.pos(t).x, fx: e + this.kp.x, fw: i - e}
        }
        ...
        var t = this, e = {
            ...
            on: {
                onAfterRender: function () {
                    ...
                    }, {bind: t}), webix.UE(t.getInputNode(), "keyup", function () {
                        t.KE()
                    })
                }
            },
    ...
    KE: function () {
        var t, e = this.getTopParentView(), i = e.$$("toolbar");
        i.setValues({
            italic: !1,
            underline: !1,
            bold: !1
    ...
    MF: function () {
        ...
        if (this.s.scale) {
            for (var x = this.s.minRange; x <= this.s.maxRange; x += this.s.scale.step) {
                var w = this.s.labelHeight || this.s.labelWidth, o = Math.floor(w + x * this.JF - (x ? .1 : -1)),
                    v = p ? (this.$width - this.s.barWidth) / 2 + -10 : o,
                    g = p ? this.NF - o + w + 44 : this.s.barWidth + 28, m = p ? -13 : this.s.barWidth + 3,
                    y = p ? "end" : "middle", $ = this.LF("tspan", ["x", "y", "text-anchor"], [v, g, y]),
        ...
        if (e.appendChild(i), "y" === this.s.layout) {
            var E = this.s.scale ? this.$width / 2 - 10 : 0, I = this.$height + this.IF - 28;
            i.setAttribute("transform", "translate(" + E + ", " + I + ") rotate(270)"), h.setAttribute("text-anchor", "middle"), h.childNodes[0].setAttribute("x", "55%"), h.childNodes[1].setAttribute("x", "55%"), d.setAttribute("text-anchor", "right")
        }
